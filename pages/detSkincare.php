				...
				<div style="margin:-540px 0 0 260px;">
					<div class="row">
						<div class="col-lg-9" style="width:890px;heigth:300px;">
							<div class="panel panel-warning"  style="margin:15px 0 50px -265px;">
									<div class="panel-heading" style="font-variant:small-caps;font-weight:bold;">
										<h4 style="text-align:center;">List Selesai Pemeriksaan SkinCare</h4>
									</div>
									...
									<table style="font-variant:small-caps;font-weight:bold;" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										<thead>
											<tr style="height:40px;border-bottom:solid 1px #ccc;background:#efefef;text-align:Center;font-weight:bold;color:red;">
												...
												<td style="width:200px;border-right:solid 1px #ccc;font-family:'Ubuntu';font-size:12px;">Nama</td>
												<td style="width:175px;border-right:solid 1px #ccc;font-family:'Ubuntu';font-size:12px;">Alamat</td>
												<td style="width:150px;border-right:solid 1px #ccc;font-family:'Ubuntu';font-size:12px;">Tangal Lahitr</td>
												<td style="width:110px;border-right:solid 1px #ccc;font-family:'Ubuntu';font-size:12px;">Jenis Kelamin</td>
												<td style="width:100px;border-right:solid 1px #ccc;;font-family:'Ubuntu';font-size:12px;">Anamnesa</td>
												<td style="width:100px;border-right:solid 1px #ccc;;font-family:'Ubuntu';font-size:12px;">Treatment</td>
											...
											<tbody>
												<?
													$no=1;
													$periksa= mysql_query("select * from tbl_skincare where status='0' order by id asc");
													...
													{																	
														...
														$a_nama= mysql_fetch_array($nama);
															...
															<tr style="height:30px;border-bottom:solid 1px #ccc;">
																...
																<td style="text-align:Center;font-size:12px;border-right:solid 1px #ccc;"><?echo $a_periksa['anamnesa'];?></td>	
																<td style="text-align:Center;font-size:12px;border-right:solid 1px #ccc;"><?echo $a_periksa['treatment'];?></td>
																<td style="border-right:solid 1px #ccc;">
																	<button type="button" class="btn btn-outline btn-success" onclick="window.location='cetakSkincare.php?id=<?echo $a_periksa['id'];?>'">
																	Selesai	
																	</button>
																</td>
															</tr>
