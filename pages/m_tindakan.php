						...
						<div class="modal fade" id="myModal1" role="dialog">
							...
							<!-- Modal content-->
								<div align=center class="modal-content" style="width:340px;">
									...
									<form method="POST" action="sTindakan.php">
										<table style="font-size:12px;"><b>
											<tr>
												<td style="font-weight:bold;">TINDAKAN</td>
												<td  style="font-weight:bold;">:</td>
												<td><input type="text" name="tindakan" class="form-control"></td>
											</tr>
						...
						<div class="col-lg-5" style="margin:0 0 10px 10px;width:800px;">
							<div class="panel panel-info" style="margin:10px 0 0 0;">
									<div class="panel-heading" style="font-variant:small-caps;">
										<button type="button" class="btn btn-outline btn-default" style="margin:0 0 0 580px;" data-toggle="modal" data-target="#myModal1">+ Tambah Tindakan</button>
									</div>
								<div class="panel-body" style="height:535px;overflow:auto;x:;">
									<table style="font-size:12px;">
										<tr style="height:40px;border-bottom:solid 1px 		#ccc;background:#00FFFF;text-align:Center;font-weight:bold;border-top:solid 1px #ccc;">
											...
											<td style="width:100px;border-right:solid 1px #ccc;">HARGA</td>
											<td style="width:350px;border-right:solid 1px #ccc;">TINDAKAN</td>
										...
										<?
											$no=1;
											$kill= mysql_query("select * from m_tindakan order by tindakan asc");
											while ($a_kill =mysql_fetch_array($kill))
											{
												?>
													<tr style="height:30px;border-bottom:solid 1px #ccc;">
														...
														<td style="text-align:Center;font-size:12px;border-left:solid 1px #ccc;border-right:solid 1px #ccc;"><?echo $a_kill['harga'];?></td>
														<td style="text-align:Center;font-size:12px;border-left:solid 1px #ccc;border-right:solid 1px #ccc;"><?echo $a_kill['tindakan'];?></td>
														<td style="border-right:solid 1px #ccc;">
															<button type="button" class="btn btn-outline btn-primary" style="margin:0 0 0 20px;" onclick="window.location='m_tindakan.php?edit=<?echo $a_kill['id'];?>'">Edit</button>
														</td>
														<td style="border-right:solid 1px #ccc;">
					...
					<div class="col-lg-5" style="margin:-613px 0 10px 770px;width:385px;">
						<div class="panel panel-success" style="margin:10px 0 0 0;">
							...
							<?
								...
								{
									?>
										<form method="POST" action="eTindakan.php">
											<table style="font-size:12px;"><b>
												<?php
													$edit=mysql_query("select*from m_tindakan where id='$_GET[edit]'");
												...
												<tr>
													<td>TINDAKAN</td>
													<td>:</td>
													<td><input type="text" name="tindakan" class="form-control" value="<?echo $a_edit['tindakan'];?>"></td>
												</tr>
												<tr style="height:3px;"></tr>
												<tr>
													<td>HARGA</td>
													<td>:</td>
													<td><input type="text" name="harga" class="form-control" value="<?echo $a_edit['harga'];?>"></td>
												</tr>
												<tr>
													<td><input type="submit" name="simpan" value="simpan" class="btn btn-outline btn-success" style="float:right;margin:0 0 0 0px;"></td>
												</tr>
